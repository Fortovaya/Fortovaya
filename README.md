...
## 📦 <sub>🔗 <a href="https://github.com/Fortovaya/Practicum_FakeNFT_SwiftUI"> FakeNFT </a></sub>
...
**Приложение для поиска и просмотра расписания поездок между станциями с использованием API Яндекс.Расписания.**
